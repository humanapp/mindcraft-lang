...
Write custom brain tiles in TypeScript using **VS Code for the Web**. The Wendoo extension connects your editor to the sim so new sensors and actuators appear in the Brain Editor's Tile Palette as you code.
...
- The `Examples` folder in the Wendoo Explorer panel contains ready-made tiles. Copy one to your workspace and it will appear in the Brain Editor immediately.
