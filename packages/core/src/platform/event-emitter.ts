...
/**
 * A lightweight event emitter built on platform-level `Dict` and `List`
 * primitives. Supports typed event maps, one-time listeners, and safe
 * listener snapshot iteration.
 */
