...
const parts: PartDef[] = [
  // Root as a capsule makes balance less "catchy" on corners.
  {
    name: "Root",
    mass: 6,
    collision: [capY(0.16, 0.18)], // ~0.52m tall capsule
    restPos: v3(0, 0, 0),
    restRot: ID,
  },
  {
    name: "Torso",
    mass: 8,
    collision: [box(0.22, 0.28, 0.14)], // ~0.44 x 0.56 x 0.28
    restPos: v3(0, 0.42, 0),
    restRot: ID,
  },
  {
...
const joints: JointDef[] = [
  ...
  // Ankles (hinge, small range)
  {
    ...
    drive: { kp: 55, kd: 10, maxTorque: 130 },
  },
  {
