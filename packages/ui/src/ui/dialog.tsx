 ...
 * covering anything, which centres the dialog in the whole viewport. It centres
 * itself vertically in the height the soft keyboard leaves free, read the same
 * way from `--keyboard-inset`, which reads `0px` with no keyboard up.
 */
