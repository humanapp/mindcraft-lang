...
import type { RelayDownstreamMessage, RelayUpstreamMessage } from "@mindcraft-lang/assistant-relay";
import { ASSISTANT_RELAY_PROTOCOL_VERSION, relayUpstreamMessageSchema } from "@mindcraft-lang/assistant-relay";
