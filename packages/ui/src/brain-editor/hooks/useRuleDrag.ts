import type { BrainCommandHistory, BrainPageDef, BrainRuleDef, RuleLocation } from "@wendoo/core/brain/model";
import { kMaxBrainRuleDepth, MoveRuleCommand } from "@wendoo/core/brain/model";
