 ...
 * action id; `fnId` references the action's {@link EcosimFuncId} member. Action
 * ids are permanent once assigned: append new records at the next free
 * action id and never renumber or reuse one.
 */
export const EcosimHostActions = {
  Bump: { key: "sensor.bump", actionId: 1024, fnId: EcosimFuncId.SensorBump },
  See: { key: "sensor.see", actionId: 1025, fnId: EcosimFuncId.SensorSee },
  Eat: { key: "actuator.eat", actionId: 1026, fnId: EcosimFuncId.ActuatorEat },
  Move: { key: "actuator.move", actionId: 1027, fnId: EcosimFuncId.ActuatorMove },
  Say: { key: "actuator.say", actionId: 1028, fnId: EcosimFuncId.ActuatorSay },
  Shoot: { key: "actuator.shoot", actionId: 1029, fnId: EcosimFuncId.ActuatorShoot },
  Turn: { key: "actuator.turn", actionId: 1030, fnId: EcosimFuncId.ActuatorTurn },
