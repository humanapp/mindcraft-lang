...
/** Body configuration for an archetype, in simulation pixels and mass units. */
...
/** Everything the engine needs to build and sustain one archetype. */
...
/** Per-archetype configuration, keyed by {@link Archetype}. */
...
/**
 * Builds an empty brain named after the archetype, used when its shipped brain
 * asset fails to load.
 *
 * @param env - The environment whose services own the new brain.
